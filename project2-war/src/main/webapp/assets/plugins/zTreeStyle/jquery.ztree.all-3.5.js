	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
					...
					"' style='", view.makeNodeIcoStyle(setting, node), "'></span><span style='display:inline-block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;' id='", node.tId, consts.id.SPAN,
					"'>",name,"</span>");
		},
