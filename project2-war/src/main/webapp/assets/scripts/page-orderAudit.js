    ...
    return {
        ...
        init: function () {
            ...
            },
            {
                ...
                return '<input type="radio" name="productIds" id="productIds" class="checkboxes" value="' + full.preOrderId + "," + full.storeId + "," + full.auditStatusCode + "," +full.storeName + '">';
            	}
            }
          ...
          var mytable= $('#models-data').dataTable({
                 ...
                 "sAjaxSource": '../orderAudit/orderAuditAjaxLists.json',//请求url
