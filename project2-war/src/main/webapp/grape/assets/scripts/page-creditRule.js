    ...
    return {
        ...
        init: function () {
            ...
            var modelsTable = $('#models-data').dataTable({
            	"bProcessing": true,
            	   "sAjaxSource": '../creditrule/creditruleAjaxList.json',
                "fnServerParams": function ( aoData ) {
                    aoData.push( 
                    		     { "name": "nStartTime", "value": $("#iStartTime").val()},
                    		     { "name": "nEndTime", "value": $("#iEndTime").val()},
                    		     { "name": "nCreditStatus", "value": $("#iCreditStatus").val()}
                                );
                },
                "sServerMethod": "POST",
                "bServerSide": true,  
                "aoColumns": [
                              { "mData": "ruleId","bSortable": false },
                              { "mData": "originName","bSortable": false },
                              { "mData": "direct","bSortable": false },
                              { "mData": "pointNum","bSortable": false },
                              { "mData": "dailyLimit","bSortable": false  },
                              { "mData": "ruleId","bSortable": false  }
                ],
                "aLengthMenu": [
                                [10, 20, 50],
                ...
                "aoColumnDefs": [{
	                ...
	                },
	                {
	                	...
	                	"mRender": function (data, type, full) {
	                		return '<input type="checkbox" name="checkbox" class="checkboxes" id="transId" value="' + data + '"/>';
	                	}
	                },
	                {
	                	'aTargets': [2],
