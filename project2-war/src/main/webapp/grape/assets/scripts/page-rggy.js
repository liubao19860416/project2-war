    ...
    return {
        ...
        init: function () {
            ...
            var modelsTable = $('#models-data').dataTable({
            	"bProcessing": true,
            	"bFilter": false,
                "sAjaxSource": '../manualorder/manualorderAjaxList.json',
                "sServerMethod": "POST",
                "bServerSide": true,  
                "fnServerParams": function ( aoData ) {
                    aoData.push( 
                    		  { "name": "keyword", "value": $("#defaultKeyword").val()}
                                );
                },
                "aoColumns": [
                              { "mData": "id","bSortable": false,"sWidth": "6%"   },
                              { "mData": "keyword","bSortable": false,"sWidth": "96%" },
                ...
                "aoColumnDefs": [{
	                ...
	                },
	                {
	                	...
	                	"mRender": function (data, type, full) {
	                		return '<input type="radio" name="checkbox" class="checkboxes" id="transId" value="' + data + '"/>';
	                	}
	                },
	                {
	                	'aTargets': [1],
	                	"mData": "",
	                	"mRender": function (data, type, full) {
	                		return '<label class="keyT" caption="'+data+'">'+data+'</label>';
	                	}
	                }
	            ],
