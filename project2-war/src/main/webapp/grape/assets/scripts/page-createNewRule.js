    ...
    return {
        ...
        init: function () {
            ...
            var modelsTable = $('#models-data').dataTable({
            	"bProcessing": true,
                "sAjaxSource": '../manualorder/createAjaxList.json',
                "sServerMethod": "POST",
                "bServerSide": true,  
                "fnServerParams": function ( aoData ) {
                    aoData.push( 
                    		     { "name": "keyToBack", "value": $("#keyToBack").val()},
                    		     { "name": "cityList", "value": $("#cityList").val()}
                ...
                "aoColumnDefs": [{
	                ...
	                },
	                {
	                	...
	                	"mRender": function (data, type, full) {
	                		return '<label caption="'+data+'" name="idStatics">'+data+'</label>';
	                	}
	                }
	               , {
	                	'aTargets': [2],
	                	"mData": "",
	                	"mRender": function (data, type, full) {
	                		return '<label caption="'+data+'" name="velName">'+data+'</label>';
	                	}
	                }, {
	                	'aTargets': [1],
	                	"mData": "",
	                	"mRender": function (data, type, full) {
	                		...
	                		return '<label caption="'+data+'" class="typeStatics">'+dataChange+'</label>';
	                	}
	                },
	                {
						sDefaultContent: '',
